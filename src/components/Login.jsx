...
const Login = () => {
  ...
  return (
    <section className="relative isolate text-white overflow-hidden p-4 min-h-screen mx-auto md:px-10 max-w-7xl lg:px-8 scroll-mt-32 grid place-items-center">
      {/* Wrapper */}
      <div className="relative flex w-full h-full justify-evenly items-center">
        ...
        <div className="flex-1">
          <div className="w-fit border-2 flex flex-col rounded-2xl p-8 mx-auto ">
            <div className="mb-6">
              <h1 className="mb-2 sm:mb-4 text-xl sm:text-2xl tracking-tight">Sign in to your account</h1>
              <p className="text-sm">
